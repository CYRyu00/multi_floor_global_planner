...
std::vector<std::vector<std::vector<double>>> stair_poses = {{{-0.1612, 3.259, 0, 0, 0, 0.4319965129, 0.901875275},{5.5462, 3.8062 ,1, 0, 0, 0.68775885, 0.7259392},{1000,1000}
                                                             ,{5.2816, 10.687, 0, 0, 0, -0.7378795, 0.951493429},{3.3560,-1.447, 0.5, 0, 0,-0.0131546,0.9999134}} , 
                                                             {{1000,1000}, { -10.801, 7.477829, 1, 0,0, -0.7378795,0.6749323},{-0.1649, 0.2791, 2, 0,0, 0.23394,0.9722510},
